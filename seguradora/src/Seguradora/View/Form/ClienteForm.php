...
class ClienteForm extends \Faderim\Ext\AbstractForm
{
    ...
    protected function createChilds()
    {
        ...
        $cpf = new Field\FormField(TypeField::TYPE_TEXT, 'cpf', 'CPF/CNPJ', true);        
        $cpf->setLabelWidth(200);

        $rg = new Field\FormField(TypeField::TYPE_NUMBER, 'rg', 'RG/IE', true, 15);        
        $rg->setLabelWidth(200);

        $email = new Field\FormField(TypeField::TYPE_EMAIL, 'email', 'E-mail', true, 250);
        $email->setLabelWidth(200);
        
        $telefone = new Field\FormField(TypeField::TYPE_TEXT, 'telefone', 'Telefone', true);
        $telefone->setLabelWidth(200);
        
        $dataCnh = new Field\FormField(TypeField::TYPE_DATE, 'dataCnh', 'Data CNH', true);
        $dataCnh->setLabelWidth(200);
        
        $dataNasc = new Field\FormField(TypeField::TYPE_DATE, 'dataNascimento', 'Data Nasc.', true);
